...
- OSX: 
```
curl -O https://github.com/mkokho/kubemrr/raw/v1.1.0/releases/darwin/amd64/kubemrr
```

- Linux: 
```
curl -O https://github.com/mkokho/kubemrr/raw/v1.1.0/releases/linux/amd64/kubemrr
```

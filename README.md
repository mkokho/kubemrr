...
- OSX: 
```
curl -O https://raw.githubusercontent.com/mkokho/kubemrr/v1.2.0/releases/darwin/amd64/kubemrr
```

- Linux: 
```
curl -O https://raw.githubusercontent.com/mkokho/kubemrr/v1.2.0/releases/linux/amd64/kubemrr
```
